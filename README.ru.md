...
Этот репозиторий — публикуемый минимум: пакет, `package.xml`, лицензия, журнал изменений и руководство автора адаптера, по одному коммиту на выпуск. Разработка (спецификация, тесты, пробы в живом FreeCAD) ведётся в рабочем репозитории, выпуск выкладывается скриптом. Внешних зависимостей нет: нужны только Python 3.11, pivy и PySide из поставки FreeCAD 1.1.
