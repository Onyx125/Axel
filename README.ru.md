...
- **Двойной щелчок** по ручке — перенос начала; **ПКМ** по началу — меню манипулятора; **Esc** — отмена перетаскивания; иначе — как щелчок в пустоте: выделение снимается, манипулятор исчезает.
